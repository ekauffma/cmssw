...
typedef BXVectorSimpleFlatTableProducer<l1t::CICADAAnomalyScore> SimpleTriggerL1CICADAAnomalyScoreFlatTableProducer;
...
DEFINE_FWK_MODULE(SimpleTriggerL1CICADAAnomalyScoreFlatTableProducer);
